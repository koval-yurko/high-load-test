...
# heartbeat Lambda, the app's OTLP export, the collector task and Grafana Cloud
# ingest. If any of them stops, all the burn rules go quiet and the dashboard
# goes flat -- and both read as healthy. heartbeat_enabled = false produces the
# same picture on purpose. This rule is what separates "quiet" from "blind".
#
