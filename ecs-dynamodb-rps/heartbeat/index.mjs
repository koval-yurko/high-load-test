...
const ROUTES = [
  { route: '/items/feed-00/item-00', method: 'GET' }, // fast
  { route: '/feeds/feed-00', method: 'GET' }, // standard
  { route: '/items', method: 'POST', body: '{}' }, // fast
  { route: '/reports', method: 'POST', body: '{"pk":"feed-00"}' }, // heavy
];
